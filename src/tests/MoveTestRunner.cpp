...
const std::set<std::string> kImplementedStatusNameRules = {
    "acidarmor", "acupressure", "afteryou", "agility", "allyswitch",
    "amnesia", "aquaring", "aromatherapy", "assist", "attackorder",
    "attract", "auroraveil", "babydolleyes", "banefulbunker", "barrier",
    "batonpass", "bellydrum", "bestow", "block", "bulkup",
    "burningbulwark", "calmmind", "camouflage", "celebrate", "charm",
    "chillyreception", "circlethrow", "confide", "confuseray", "conversion",
    "conversion2", "copycat", "corrosivegas", "cottonguard", "courtchange",
    "craftyshield", "curse", "defendorder", "defog", "destinybond",
    "detect", "disable", "doodle", "doubleteam", "dragoncheer",
    "dragondance", "dragontail", "eerieimpulse", "electricterrain", "electrify",
    "embargo", "encore", "endure", "entrainment", "fairylock",
    "faketears", "featherdance", "flash", "flatter", "floralhealing",
    "focusenergy", "followme", "foresight", "forestscurse", "gastroacid",
    "grassyterrain", "gravity", "growl", "growth", "grudge",
    "guardsplit", "guardswap", "hail", "happyhour", "haze",
    "healbell", "healblock", "healingwish", "healorder", "healpulse",
    "heartswap", "helpinghand", "holdhands", "honeclaws", "imprison",
    "ingrain", "instruct", "iondeluge", "irondefense", "junglehealing",
    "kinesis", "kingsshield", "laserfocus", "leechseed", "leer",
    "lifedew", "lightscreen", "lockon", "luckychant", "lunarblessing",
    "lunardance", "magiccoat", "magicpowder", "magicroom", "magnetrise",
    "matblock", "maxguard", "meanlook", "mefirst", "meditate",
    "metalsound", "metronome", "milkdrink", "mimic", "mindreader",
    "minimize", "miracleeye", "mirrormove", "mist", "mistyterrain",
    "moonlight", "morningsun", "mudsport", "nastyplot", "naturepower",
    "nightmare", "nobleroar", "obstruct", "odorsleuth", "painsplit",
    "perishsong", "playnice", "powerswap", "psychicterrain", "psychup",
    "purify", "quash", "quickguard", "quiverdance", "raindance",
    "recover", "recycle", "reflect", "reflecttype", "refresh",
    "rest", "roar", "roleplay", "roost", "safeguard",
    "sandstorm", "screech", "shellsmash", "shoreup", "simplebeam",
    "sketch", "skillswap", "slackoff", "sleeptalk", "snatch",
    "snowscape", "soak", "softboiled", "spiderweb", "spikes",
    "spikyshield", "spite", "spitup", "splash", "spotlight",
    "stealthrock", "stickyweb", "stockpile", "substitute", "sunnyday",
    "supersonic", "swallow", "sweetkiss", "sweetscent", "switcheroo",
    "swordsdance", "synthesis", "tailglow", "tailwhip", "tailwind",
    "taunt", "telekinesis", "teleport", "tickle", "torment",
    "toxicspikes", "transform", "trick", "trickortreat", "trickroom",
    "victorydance", "whirlwind", "wideguard", "wish", "withdraw",
    "wonderroom", "workup", "worryseed", "yawn",
    "octolock", "powder", "powershift", "powersplit", "powertrick",
    "psychoshift", "ragepowder", "revivalblessing", "sandattack", "shadowdown",
    "shadowhold", "shadowmist", "shadowpanic", "shadowshed", "shadowsky",
    "shedtail", "shelter", "smokescreen", "speedswap", "teatime",
    "teeterdance", "topsyturvy", "takeheart", "watersport",
};
